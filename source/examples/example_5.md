...
Note: This example requires a Mapbox access token. [Sign up here](https://www.mapbox.com/)

### Demo

{% iframe ../demos/example_5_demo.html 100% 450 %}


### See also

+ [Mapbox GL JS Example](https://docs.mapbox.com/mapbox-gl-js/example/3d-buildings/)
