...
{% iframe ../demos/example_8_demo.html 100% 450 %}

### See also

+ [Deck.gl Scatterplot Layer Docs](https://deck.gl/#/documentation/deckgl-api-reference/layers/scatterplot-layer)
+ [Deck.gl Arc Layer Docs](https://deck.gl/#/documentation/deckgl-api-reference/layers/arc-layer)
