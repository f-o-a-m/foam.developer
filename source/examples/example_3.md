    ...
    new DeckGL({
      ...
      layers: [
        new ScatterplotLayer({
          id: 'scatter-plot',
          data: 'https://map-api-direct.foam.space/poi/filtered?limit=100&swLng=' + BOUNDING_BOX[1][0] + '&swLat=' + BOUNDING_BOX[1][1] + '&offset=0&sort=oldest&status=removed&status=listing&neLng=' + BOUNDING_BOX[0][0] + '&neLat=' + BOUNDING_BOX[0][1],
