---
layout: post
title: Map local restaurants
---

# Map local restaurants

Find somewhere to eat. This example uses `Deck.gl` and `Mapbox tiles`.

### Demo

{% iframe ../demos/example_7_demo.html 100% 450 %}

### See also

+ [Deck.gl Text Layer Spec](https://github.com/uber/deck.gl/blob/master/docs/layers/text-layer.md)
